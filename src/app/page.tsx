        ...
        <div className="max-w-6xl mx-auto px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="flex justify-center">
              <div className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden ring-4 ring-[#d4a088]/40 bg-[#0d1c30] [transform:translateZ(0)] [backface-visibility:hidden] [-webkit-mask-image:radial-gradient(circle,white_100%,transparent_100%)]">
                <Image
                  src="/dr-japa.png"
                  alt="Dr. Sohan Japa"
                  fill
